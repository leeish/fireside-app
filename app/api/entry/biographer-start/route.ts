...
Feel like an invitation to share something real, not a form field or interview prompt.`,
    ...
    if (convError || !conversation) {
      console.error('[biographer-start] conversation insert error:', convError)
    ...
    if (turnError) {
      console.error('[biographer-start] turn insert error:', turnError)
    ...
    console.error('[biographer-start] unhandled error:', err)
